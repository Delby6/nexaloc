...
export default function AdminNotifications() {
  ...
  /* -------------------------------------------
     NOTIFICATIONS (FROM CONTEXT — SINGLE SOURCE)
  ------------------------------------------- */
  const {
    notifications,
    loading,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            System alerts, escalated reviews, and owner activity summaries.
          </p>
        </div>
            ...
            className={`px-3 sm:px-4 py-1.5 text-xs sm:text-sm rounded-full transition
              ${
                activeTab === tab.id
                  ...
                  : "text-slate-600 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-slate-800"
              }`}
          >
            {tab.label}
          </button>
              ...
              className={`p-4 rounded-xl border flex justify-between gap-4 transition-all
                ${
                  n.read
                    ...
                    : "bg-white dark:bg-slate-900 border-sky-400 shadow-sm shadow-sky-900/30"
                }`}
            >
              <div
